...
<head>
    ...
    <title>Admin</title>
    <!-- Favicon icon -->
    <link rel="stylesheet" href="{{asset('asset/images/favicon.png')}}">
    <link rel="stylesheet" rel="icon" type="image/png" sizes="16x16" href="{{asset('asset/images/favicon.png')}}">
    ...
    <link href="{{asset('asset/vendor/summernote/summernote.css')}}" rel="stylesheet">
    <link rel="stylesheet" href="{{asset('asset/css/style.css')}}">
    <link rel="stylesheet" href="{{asset('asset/vendor/datatables/css/jquery.dataTables.min.css')}}">
...
<body>
        ...
        <div class="quixnav">
            <div class="quixnav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li><a href="{{url('admin') }}" class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                                class="icon icon-single-04"></i><span class="nav-text">Trang Chủ</span></a>
                    </li>

                    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                                class="icon icon-chart-bar-33"></i><span class="nav-text">Thanh Menu</span></a>
                        <ul aria-expanded="false">
                            <li><a href="{{url('categories/create') }}">Thêm Loại</a></li>
                            <li><a href="{{url('categories') }}">Danh Sách </a></li>
                        </ul>
                    </li>
                    <li class="nav-label">Sản Phẩm</li>
                    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                                class="icon icon-world-2"></i><span class="nav-text">Sản Phẩm</span></a>
                        <ul aria-expanded="false">
                            <li><a href="{{url('products/create') }}">Thêm Sản Phẩm</a></li>
                    ...
                    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                                class="icon icon-plug"></i><span class="nav-text">Khách Hàng</span></a>
                        <ul aria-expanded="false">
                    ...
                    <li class="nav-label">Tin Tức</li>
                    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                                class="icon icon-form"></i><span class="nav-text">Tin Tức</span></a>
                        <ul aria-expanded="false">
                            <li><a href="{{url('news/create') }}">Thêm Tin Tức</a></li>
                            <li><a href="{{url('news') }}">Danh Sách</a></li>
                        </ul>
                    </li>
    ...
    <!-- All init script -->
    <script src="{{asset('asset/js/plugins-init/toastr-init.js')}}"></script>
      <!-- Required vendors -->
    <script src="{{asset('asset/vendor/global/global.min.js')}}"></script>
    <script src="{{asset('asset/js/quixnav-init.js')}}"></script>
    <script src="{{asset('asset/js/custom.min.js')}}"></script>
